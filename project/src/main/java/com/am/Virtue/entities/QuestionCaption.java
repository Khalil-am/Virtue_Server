...
@Entity
@Table(name = "Question_Caption")
public class QuestionCaption {
        @Id
        @GenericGenerator(
                name = "QuestionCaption",
                strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator",
                parameters = {
                        @org.hibernate.annotations.Parameter(name = "sequence_name", value = "QuestionCaption_SEQUENCE"),
                        @org.hibernate.annotations.Parameter(name = "initial_value", value = "1"),
                        @org.hibernate.annotations.Parameter(name = "increment_size", value = "1")
                })
        @GeneratedValue(generator = "QuestionCaptionGenerator")
